...
ALTER TABLE public.teams ALTER COLUMN team_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.teams_teams_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
SELECT pg_catalog.setval('public.teams_teams_id_seq', 88, true);
...
--
-- Name: games fk_opponent_game; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_opponent_game FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
